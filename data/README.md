...
Please download the dataset into the following directory: `./data/dataset/RC_dataset`

## 2. Download Temporal Segmentation Annotations

Download the zip file containing all the CSV files for annotations from [this link](https://doi.org/10.6084/m9.figshare.26472913), unzip it, and save everything in `./data/dataset/RC_annotations`.

## 3. Run Feature Extraction

Feature extraction script encodes video frames into their latent representations using a predefined encoder model. It supports augmentation and handles multiple videos in batches.
