...
Usage:
CUDA_VISIBLE_DEVICES=0 python src/inference.py -parFile ymls/inference/inference_colontcn_5fold.yml
"""
import argparse
import yaml
import torch
...
def main(args):
    ...
    print(f"Parsing configuration file: {args.par_file}")
...
if __name__ == '__main__':
    ...
    parser.add_argument('-parFile', action='store', dest='par_file', required=True,
